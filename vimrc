...
" CoC completion manager. Install
" - coc-clangd: C/C++ language server
" - coc-sh: Shell language server
Plug 'neoclide/coc.nvim', { 'branch': 'release', 'do': ':CocInstall coc-sh coc-clangd'}
...
" Check so that CoC is installed and loaded
